...
static int mmc_pwrseq_sd8787_probe(struct platform_device *pdev)
{
	...
	// Default control by sysfs attribute power_ctl
	pwrseq->use_sysfs_control = true;
